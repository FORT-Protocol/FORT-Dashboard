  ...
  return (
    <Stack spacing={["22px", "22px", "44px"]} p={["22px", "22px", "44px"]}>
      <SimpleGrid columns={[1, 1, 2, 2, 4]} spacing={["22px", "22px", "44px"]}>
        ...
        <Norm value={curOpenLongPositions} desc={"Current Open Long Positions (NEST)"} color={"#00B388"}/>
        <Norm value={curOpenShortPositions} desc={"Current Open Short Positions (NEST)"} color={"#F23A12"}/>
      ...
      <SimpleGrid columns={1} spacing={["22px", "22px", "44px"]}>
        <LineChart title={"Open Position"} suffix={"NEST"} data={openingVolumeList}/>
        <LineChart title={"Open Interest"} suffix={"NEST"} data={positionInterest} noTotal/>
      </SimpleGrid>
      ...
      <SimpleGrid columns={1}>
        <PieChart title={"Open Price distribution (NEST)"} data={openPriceDistribution}/>
      </SimpleGrid>
    </Stack>
  )
}
